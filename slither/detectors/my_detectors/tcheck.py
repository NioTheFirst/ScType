...
class tcheck(AbstractDetector):
    ...
    WIKI = 'Output by ScType'

    WIKI_TITLE = 'None'
    WIKI_DESCRIPTION = 'ScType tool for accounting errors in smart contracts'
    WIKI_EXPLOIT_SCENARIO = 'Erroneous accounting mistakes'
