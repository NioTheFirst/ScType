...
Hence, the return values of functions not included within detection scope need to be provided as annotations in the type file, since the functions cannot be typechecked, and therefore the types for the return values would be unknown.
