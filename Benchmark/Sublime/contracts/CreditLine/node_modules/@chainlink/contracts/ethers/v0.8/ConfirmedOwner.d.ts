...
interface ConfirmedOwnerInterface extends Interface {
  functions: {
...
export class ConfirmedOwner extends Contract {
  connect(signerOrProvider: Signer | Provider | string): ConfirmedOwner;
  attach(addressOrName: string): ConfirmedOwner;
  deployed(): Promise<ConfirmedOwner>;

  on(event: EventFilter | string, listener: Listener): ConfirmedOwner;
  once(event: EventFilter | string, listener: Listener): ConfirmedOwner;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): ConfirmedOwner;
  removeAllListeners(eventName: EventFilter | string): ConfirmedOwner;
  removeListener(eventName: any, listener: Listener): ConfirmedOwner;
