...
const MockAggregatorValidator = contract({
...
if (process.env.NODE_ENV === 'test') {
  try {
    eval('MockAggregatorValidator.setProvider(web3.currentProvider)')
  } catch (e) {}
}

exports.MockAggregatorValidator = MockAggregatorValidator
