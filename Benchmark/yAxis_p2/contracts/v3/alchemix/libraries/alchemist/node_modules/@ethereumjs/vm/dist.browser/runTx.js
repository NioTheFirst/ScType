...
function _runTx(opts) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var state, tx, block, caller, basefee, gasLimit, maxFeePerGas, baseFeePerGas, fromAccount, nonce, balance, cost, cost_1, gasPrice, inclusionFeePerGas, baseFee, baseFee, txCost, txContext, value, data, to, message, evm, results, gasRefund, maxRefundQuotient, maxRefund, actualTxCost, txCostDiff, miner, minerAccount, keys, keys_1, keys_1_1, k, address, e_2_1, cumulativeGasUsed, _c, event;
        var e_2, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 17:
                    ...
                    cumulativeGasUsed = ((_b = opts.blockGasUsed) !== null && _b !== void 0 ? _b : block.header.gasUsed).add(results.gasUsed);
                    _c = results;
