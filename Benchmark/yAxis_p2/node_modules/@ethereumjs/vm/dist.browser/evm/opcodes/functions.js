    ...
    [
        ...
        function (runState) {
            ...
            if (!dataLength.eqn(0)) {
                ...
                var data = util_1.getDataSlice(runState.eei.getCode(), codeOffset, dataLength);
                var memOffsetNum = memOffset.toNumber();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            code = _b.sent();
                            data = util_1.getDataSlice(code, codeOffset, dataLength);
    ...
    [
        ...
        function (runState) {
            ...
            if (!dataLength.eqn(0)) {
                ...
                var data = util_1.getDataSlice(runState.eei.getReturnData(), returnDataOffset, dataLength);
                var memOffsetNum = memOffset.toNumber();
                var lengthNum = dataLength.toNumber();
                runState.memory.extend(memOffsetNum, lengthNum);
                runState.memory.write(memOffsetNum, lengthNum, data);
