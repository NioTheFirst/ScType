...
interface IIncentivizerInterface extends ethers.utils.Interface {
  functions: {
...
export class IIncentivizer extends BaseContract {
  ...
  interface: IIncentivizerInterface;
  ...
  functions: {
    ...
    fees(token: string, overrides?: CallOverrides): Promise<[BigNumber]>;
