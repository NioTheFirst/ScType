...
interface IProductProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class IProductProvider extends BaseContract {
  ...
  interface: IProductProviderInterface;
