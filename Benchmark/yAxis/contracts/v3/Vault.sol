...
contract Vault is VaultToken, IVault {
	...
	uint256 _amount = (balance2().mul(_shares)).div(totalSupply());
	...
	//_balance = _balance.add(_normalizeDecimals(_tokens[0], IERC20(_tokens[0]).balanceOf(address(this))));
	return _balance;
    }
